...
Core workflow that:
- Sets up language-specific environments (Node.js v24.13.0, Python via pyproject.toml, Java 21)
...
- **npm/yarn**: Node.js v24.13.0, package-lock.json/yarn.lock caching
